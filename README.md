I found loads of OP Minecraft seeds so i thought: Why not store it somewhere-so I did. All seeds found by me/sometimes Copilot. All this seeds work for the latest version of Bedrock Edition (26.20) and so that means if you use these devices, these seeds will work: Minecraft for windows 10/11, any console (Xbox, PS5, PS4, Nintendo), or mobile device (Android, iPad or iPhone). If you use any other device, make sure you are using Bedrock Edition or else these seeds will probably not work. Software compatibility list is at minecraft.net.
